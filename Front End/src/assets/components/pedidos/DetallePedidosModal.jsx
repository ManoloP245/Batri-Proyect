...
export function DetallePedidosModal() {
  ...
  return (
    <>
      <div className=" flex mx-2">
        <Button onClick={() => handleOpen("xxl")} variant="gradient" className="flex" > <EyeIcon strokeWidth={2} className="h-4 w-4" />
          <span></span>
        </Button>
      </div>
      <Dialog
        ...
        handler={handleOpen}
      >
        <DialogHeader>Ver Pedidos</DialogHeader>
        <DialogBody>
